	...
	AFRAME.registerComponent('streetview', {
	  ...
	  init: function () {
	    ...
	    window.onGoogleMapAPILoaded = function(){
	      document.querySelectorAll("[streetview-img]").forEach(function(entity){
	        entity.components["streetview-img"].loadPano();
	      })
	    }
	  ...
	  loadPano: function(){
	    ...
	    l.addEventListener( 'load', function() {
	      ...
	      if(that.el.object3D.children[0].geometry.metadata.type === "SphereGeometry"){
	        sphereElt = that.el;
	      }
	      else{
